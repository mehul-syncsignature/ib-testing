// components/instant-branding/social-banner/social-banner-template-2/MockupPostTemplate3.tsx
...
// import { Mockup3 } from "@/public/mockup-background-svgs"; // Replaced with AWS asset key
import { modifySvg } from "@/common/utils/modify-svg";

function MockupPostTemplate3({
  data,
  brand,
  className = "",
  style,
...
ComponetProps) {
  ...
  const bgsvg = modifySvg("mockup3", `${width}px`, `${height}px`);
