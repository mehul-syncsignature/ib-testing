...
import {
  ...
  ColorTrio,
  colorTrios,
} from "@/app/app/brand-setup/BrandControls/components/ColorPaletteDropdown";
...
const OnboardingPage = () => {
  ...
  useEffect(() => {
    ...
    router.prefetch("/app/design-templates/social-banner");
  }, [router]);
  ...
  return (
    ...
    >
      ...
      <div className="hidden">
        ...
        <Link href="/app/design-templates/social-banner" prefetch={true}>
          Dashboard
        </Link>
      </div>
    </main>
