...
> = {
  all: {
    ...
    description:
      "Start creating amazing designs and they will appear here. Your creative journey begins with a single click.",
  ...
  "social-banner": {
    ...
    description:
      "Design stunning social media banners that make your brand stand out across all platforms.",
  ...
  "social-post": {
    title: "Ready to Post?",
    description:
      "Design engaging social media posts that capture attention and build your audience.",
  ...
  "quote-card": {
    ...
    description:
      "Design beautiful, shareable quote cards that inspire and motivate your followers.",
  ...
  "featured-post": {
    ...
    description:
      "Create eye-catching designs for your featured posts to draw in more readers.",
  ...
  "mockup-post": {
    ...
    description:
      "Present your products and ideas professionally with polished mockup designs.",
  ...
  "textimg-post": {
    ...
    description:
      "Combine powerful text with striking images for maximum impact on your audience.",
  ...
  "social-carousel": {
    ...
    description:
      "Design engaging carousels to guide your audience through a compelling narrative.",
    cta: "Create Carousel",
  ...
  return (
    <div className="flex min-h-[500px] w-full items-center justify-center bg-transparent p-4">
      ...
      >
        ...
        {/* Content */}
        <motion.div variants={FADE_IN_VARIANTS} className="flex flex-col gap-2">
